...
**In-repo portable version**. This skill implements the autoresearch methodology: an autonomous experiment loop that iterates a single file against a measurable metric, keeping improvements and discarding regressions.
