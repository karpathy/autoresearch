...
- **Dry-run behavior:** Status defaults to `keep`, touches list is populated via the scoped `TaskSlice`, and `privacy_guard.redact_text` ensures secrets do not leak into reports.
