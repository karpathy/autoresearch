...
# Global variables for DDP and kernels
ddp = False
ddp_rank = 0
ddp_local_rank = 0
ddp_world_size = 1
...
if __name__ == "__main__":
    ...
    current_total_batch_size = grad_accum_steps * tokens_per_fwdbwd
    ...
    total_tokens = step * current_total_batch_size
    ...
    steady_state_mfu = 100 * num_flops_per_token * current_total_batch_size * (step - 10) / total_training_time / H100_BF16_PEAK_FLOPS if total_training_time > 0 else 0
