...
def get_lr_multiplier(progress):
    if progress < WARMUP_RATIO:
        ...
        # Inverse square root schedule: 1/sqrt(1 + step_ratio)
        step_ratio = (progress - WARMUP_RATIO) / (1.0 - WARMUP_RATIO) if WARMUP_RATIO < 1.0 else 0
        return 1.0 / (1.0 + step_ratio)**0.5
