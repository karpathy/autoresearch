...
USE_FLASH_ATTN = cap[0] >= 8  # Ampere or newer only
...
class GPT(nn.Module):
    ...
    def init_weights(self):
        ...
        # Keep weights in default dtype for V100 stability
        pass
...
EMBEDDING_LR = 0.08      # learning rate for token embeddings (Adam)
